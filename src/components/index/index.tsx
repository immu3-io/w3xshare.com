                  ...
                  <div className='px-4 md:px-0 lg:w-6/12'>
                    <div className='md:mx-6 md:p-12'>
                      <div className='text-center'>
                        <img className='mx-auto w-80 block dark:hidden' src='/img/pxDrive_1.svg' alt='PollinationX Drive Logo' />
                        <img className='mx-auto w-80 hidden dark:block' src='/img/pxDrive_2.svg' alt='PollinationX Drive Logo' />
                      </div>
                      <form>
