          ...
          <div className='flex items-center justify-between'>
            <div className='flex items-center justify-start'>
              ...
              <a href='/' className='flex ml-2 md:mr-24'>
                <img className='h-12 mr-3 block dark:hidden' src='/img/pxDrive_1.svg' alt='PollinationX Drive Logo' />
                <img className='h-12 mr-3 hidden dark:block' src='/img/pxDrive_2.svg' alt='PollinationX Drive Logo' />
              </a>
            </div>
